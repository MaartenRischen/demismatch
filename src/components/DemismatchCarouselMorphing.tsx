...
export default function DemismatchCarouselMorphing({ minimal = false, vertical = false }: CarouselProps) {
  ...
  // Vertical layout for side-by-side with text
  if (vertical) {
    return (
      <div className="w-full h-full min-h-[400px]">
        <div
          ...
          onClick={handleClick}
        >
          {/* Vertical morphing image strip */}
          <div
            className="relative w-full h-full overflow-hidden rounded-xl shadow-lg"
          >
            {/* Image container with all 3 images stacked vertically */}
            <div className="absolute inset-0">
              <div className="relative w-full h-full">
                {/* Image 1 - Mismatched (top third) */}
                <div
                ...
                {/* Image 3 - Augmented (bottom third) */}
                <div
                ...
                {/* Reveal wipe overlay - animated terracotta glow that sweeps down */}
                <div
